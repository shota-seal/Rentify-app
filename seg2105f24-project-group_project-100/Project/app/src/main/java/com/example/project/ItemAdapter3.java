...
public class ItemAdapter3 extends ArrayAdapter<Item> {
    private Context context;
    private ArrayList<Item> items;

    public ItemAdapter3(Context context, ArrayList<Item> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        numberOfInterestedUsers.setText("Rented to: " + currentItem.getOnLoanTo());
